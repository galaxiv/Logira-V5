        ...
        <section id="about" className="max-w-7xl mx-auto px-6 md:px-10 pb-16">
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="text-white/70 space-y-4 text-lg">
              ...
              <p>
                The project is developed in collaboration with professional mathematicians and experienced teachers, ensuring that every challenge is both intellectually rigorous and pedagogically meaningful.
              </p>
              <p>
        ...
        <section id="contact" className="max-w-7xl mx-auto px-6 md:px-10 pb-24">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6 md:p-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                <div className="text-sm text-white/60 uppercase">Contact</div>
                <div className="mt-2 text-lg text-white/80">Have questions or want to collaborate?</div>
              </div>
              <div className="flex flex-col md:flex-row gap-3 md:gap-6 text-white/85">
                <a href="mailto:info@logira.app" className="rounded-xl border border-white/10 bg-black/20 px-4 py-2 hover:bg-white/10 transition">
                  info@logira.app
                </a>
                <a href="https://t.me/Logira_app" target="_blank" rel="noreferrer" className="rounded-xl border border-white/10 bg-black/20 px-4 py-2 hover:bg-white/10 transition">
                  Telegram: @Logira.app
                </a>
              </div>
            </div>
